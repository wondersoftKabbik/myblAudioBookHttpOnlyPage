...
export async function middleware(req) {
  ...
  let msisdn = req.headers.get('x-msisdn') || req.headers.get('X-MSISDN') || req.headers.get('msisdn') || req.headers.get('MSISDN') || req.headers.get('x-access-number') || req.nextUrl?.searchParams.get('number')
  if(msisdn){
